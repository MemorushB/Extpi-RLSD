...
INPUT_JSONL="${INPUT_JSONL:-${EXTPI_DATA_ROOT}/datasets/opsd_clean/all_clean_qwen32b_pi.jsonl}"
...
OUTPUT_JSONL="${OUTPUT_JSONL:-${EXTPI_DATA_ROOT}/datasets/opsd_clean/all_clean_qwen32b_pi_screened.jsonl}"
